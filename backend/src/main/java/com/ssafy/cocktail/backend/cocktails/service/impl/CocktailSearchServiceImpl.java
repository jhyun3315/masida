...
public class CocktailSearchServiceImpl implements CocktailSearchService {
    ...
    public ArrayList<CocktailMain> getCocktailMainList() {
        ...
        for (CocktailLikesInterface cocktail: cocktailLikesInterfaces) { // 칵테일
            ...
            if (cocktail.getCocktailNameKo() == null || cocktail.getCocktailRating() == null) {
                CocktailMain cocktailMain = new CocktailMain(cocktail.getCocktailId(),cocktail.getCocktailNameEn(), cocktail.getCocktailNameEn(), cocktail.getCocktailImg(), 0.0); // 랜덤 칵테일 1개 생성
